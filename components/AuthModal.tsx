      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="hidden md:flex w-2/5 bg-indigo-900 text-white p-12 flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                <SettlaLogo className="h-12 w-auto text-indigo-400 mb-12" />
                ...
                <p className="text-indigo-200/60 font-medium text-lg max-w-xs leading-relaxed">
            ...
            <div className="flex-1 p-8 md:p-16 relative">
              ...
              <button 
                onClick={onClose}
                className="absolute top-8 right-8 w-10 h-10 flex items-center justify-center rounded-full bg-indigo-50 text-indigo-900 hover:bg-indigo-100 transition-colors"
              >
              ...
              <div className="max-w-md mx-auto">
                <div className="mb-10">
                  <h3 className="text-3xl md:text-4xl font-black text-indigo-950 tracking-tight mb-2">
                    {mode === 'login' ? 'Login' : 'Create Account'}
                  </h3>
                  <p className="text-indigo-900/40 font-medium text-sm">
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  {mode === 'signup' && (
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-50 border border-indigo-50 rounded-2xl pl-14 pr-6 py-4 text-indigo-950 outline-none focus:border-indigo-600 focus:bg-white transition-all font-medium"
                      />
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between px-2 pt-2">
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <input type="checkbox" className="w-4 h-4 rounded border-indigo-200 text-indigo-600 focus:ring-indigo-600" />
                      <span className="text-xs font-bold text-indigo-900/60 group-hover:text-indigo-600 transition-colors">Remember me</span>
                    </label>
                    <a href="#" className="text-xs font-bold text-indigo-600 hover:underline">Forgot password?</a>
                  </div>

                  <button className="w-full bg-indigo-600 text-white py-4 rounded-2xl font-black text-lg shadow-xl shadow-indigo-100 hover:bg-indigo-700 transition-all active:scale-[0.98] mt-4">
