...
const SettlaSecure: React.FC = () => {
  return (
    <section className="py-24 bg-indigo-950 relative overflow-hidden font-sans">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2 order-1 lg:order-2 text-center lg:text-left">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-black mb-6 text-white leading-[0.95] tracking-tighter">
                Your money’s <br /> <span className="text-indigo-400">safe space.</span>
              </h2>

              <p className="text-lg md:text-xl text-indigo-100/60 leading-relaxed mb-10 font-medium">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
                {[
                  ...
                  <div key={idx} className="bg-white/5 border border-white/10 p-6 rounded-[1.5rem] hover:bg-white/10 transition-colors">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="mt-10 bg-white text-indigo-950 px-8 py-4 rounded-full font-bold text-base shadow-2xl hover:bg-indigo-50 transition-all"
              >
