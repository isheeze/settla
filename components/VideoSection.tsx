  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden flex items-center justify-center font-sans py-24">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 text-center text-white">
        ...
        >
          <div className="inline-flex items-center gap-3 border border-white/20 bg-white/10 backdrop-blur-md px-5 py-2 rounded-full mb-6">
          ...
          <p className="text-lg md:text-xl text-indigo-100/60 max-w-2xl mx-auto mb-10 font-medium leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
            <button className="bg-white text-indigo-950 px-8 py-4 rounded-full font-bold text-base hover:bg-indigo-50 hover:scale-105 active:scale-95 transition-all shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
              Enter the Protocol
            </button>
            <button className="bg-white/5 border border-white/20 backdrop-blur-xl text-white px-8 py-4 rounded-full font-bold text-base hover:bg-white/10 transition-all">
              Developer Docs
            </button>
          </div>
        </motion.div>
        ...
        <div className="mt-10 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-2xl border border-white/10 p-6 rounded-[2rem]"
            >
              <div className="text-indigo-300 font-black text-[10px] uppercase tracking-widest mb-1 opacity-60">
                {stat.label}
              </div>
