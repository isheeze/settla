...
const AboutPage: React.FC = () => {
  return (
    <div className="bg-white font-sans overflow-hidden">
      ...
      <section className="relative pt-48 pb-32 px-6 bg-indigo-50">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            <div className="inline-block px-4 py-1.5 bg-indigo-600/10 rounded-full mb-8">
              <span className="text-indigo-600 font-black text-[10px] uppercase tracking-[0.3em]">Our Story</span>
            </div>
            <h1 className="text-6xl md:text-9xl font-black text-indigo-950 tracking-tighter leading-[0.85] mb-10">
              Money without <br /> <span className="text-indigo-600">friction.</span>
            </h1>
            <p className="text-xl md:text-3xl text-indigo-900/40 max-w-3xl mx-auto font-medium leading-relaxed">
        ...
        <motion.div 
          ...
          className="absolute -bottom-24 -right-24 w-96 h-96 border-2 border-indigo-100/50 rounded-[4rem] -z-0"
        ></motion.div>
      </section>
      ...
      <section className="py-32 px-6 relative bg-white">
        <div className="max-w-7xl mx-auto text-center">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="flex flex-wrap justify-center -space-x-4 md:-space-x-12 mb-20"
          >
            {BOARD_MEMBERS.map((member, i) => (
              <motion.div
                ...
                className="relative w-24 h-24 md:w-40 md:h-40 rounded-full border-4 border-white shadow-2xl overflow-hidden cursor-pointer bg-indigo-100 group"
              >
                <img src={member.image} alt={member.name} className="w-full h-full object-cover transition-transform group-hover:scale-110" />
                <div className="absolute inset-0 bg-indigo-900/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center text-white p-4 transition-opacity text-center">
          ...
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-5xl md:text-7xl font-black text-indigo-950 tracking-tighter leading-[0.9] mb-8"
          >
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl text-indigo-900/60 max-w-2xl mx-auto font-medium"
          >
      ...
      <section className="py-40 px-6 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center mb-32 text-center">
             <h2 className="text-4xl md:text-6xl font-black text-indigo-950 tracking-tight mb-6">What's done and <span className="text-indigo-600">what's left.</span></h2>
            ...
            <div className="space-y-40">
              {TIMELINE_DATA.map((item, idx) => (
                <motion.div 
                  ...
                  className="relative grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24"
                >
                  {/* Timeline Marker */}
                  ...
                  <div className={`${idx % 2 === 0 ? 'md:text-right' : 'md:order-2 md:text-left'}`}>
                    <h4 className="text-indigo-600 font-black text-xs uppercase tracking-[0.4em] mb-4">{item.year}</h4>
                    <h3 className="text-3xl md:text-5xl font-black text-indigo-950 mb-6">{item.title}</h3>
                    <p className="text-indigo-900/60 text-lg leading-relaxed mb-8 max-w-xl md:ml-auto md:mr-0">
                      {item.description}
                    </p>
                  </div>
      ...
      <section id="support" className="py-40 px-6 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            >
              ...
              <p className="text-xl text-indigo-900/60 mb-12 max-w-md font-medium leading-relaxed">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-start gap-6 p-6 rounded-3xl bg-slate-50 border border-indigo-50 hover:border-indigo-200 transition-colors group">
                    <div className="w-12 h-12 flex-shrink-0 bg-white rounded-2xl flex items-center justify-center text-xl shadow-sm group-hover:scale-110 transition-transform">
                      {item.icon}
                    </div>
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-widest text-indigo-400 mb-1">{item.label}</p>
                      <p className="text-indigo-950 font-bold">{item.val}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-indigo-950 p-8 md:p-12 rounded-[3.5rem] shadow-2xl relative"
            >
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-indigo-300/50 ml-4">Full Name</label>
                    <input type="text" placeholder="John Doe" className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-white/20 outline-none focus:border-indigo-400 focus:bg-white/10 transition-all" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-indigo-300/50 ml-4">Email Address</label>
                    <input type="email" placeholder="john@example.com" className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-white/20 outline-none focus:border-indigo-400 focus:bg-white/10 transition-all" />
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-indigo-300/50 ml-4">Subject</label>
                  <select className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white/60 outline-none focus:border-indigo-400 focus:bg-white/10 transition-all appearance-none">
                ...
                <div className="space-y-2">
                  ...
                  <textarea rows={4} placeholder="How can we help you?" className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-white/20 outline-none focus:border-indigo-400 focus:bg-white/10 transition-all resize-none"></textarea>
                </div>

                <motion.button 
                  whileHover={{ scale: 1.02, backgroundColor: "#4f46e5" }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-indigo-600 text-white py-5 rounded-2xl font-black text-lg flex items-center justify-center gap-3 shadow-xl shadow-indigo-600/20 transition-all"
                >
                  Send Message
