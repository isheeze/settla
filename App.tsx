      ...
      <main>
        {currentPage === 'home' ? (
          <>
            ...
            {/* Final CTA Section */}
            <section className="bg-indigo-50 py-40 text-center px-6 relative overflow-hidden">
              ...
              <div className="max-w-4xl mx-auto relative z-10">
                ...
                <h2 className="text-5xl md:text-7xl font-black mb-8 tracking-tighter text-indigo-950 leading-[0.95]">
                  Ready to join the <br /> <span className="text-indigo-600">revolution?</span>
                </h2>
                <p className="text-indigo-900/60 text-xl md:text-2xl mb-12 max-w-2xl mx-auto leading-relaxed font-medium">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  <button 
                    ...
                    className="bg-indigo-600 text-white px-12 py-6 rounded-full font-black text-xl hover:bg-indigo-700 hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-indigo-200"
                  >
                    Open Free Account
                  </button>
                  <button className="bg-white border-2 border-indigo-100 text-indigo-950 px-12 py-6 rounded-full font-black text-xl hover:border-indigo-200 transition-all">
                    Contact Sales
                  </button>
                </div>
              </div>
